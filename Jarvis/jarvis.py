"""
Jarvis AI Assistant
A comprehensive AI voice assistant with 16+ advanced features.

Original Creator: Kishan Kumar Rai
Enhanced by: AlienFromMars-itzme (https://github.com/AlienFromMars-itzme)

Features:
- AI-powered conversations (OpenAI GPT/Google Gemini)
- Multiple voice options with runtime switching
- Full system automation and monitoring
- Smart reminders with natural language parsing
- News, weather, and WhatsApp integration
- Voice-activated calculator and much more!
"""
...
def main():
    ...
    try:
        # Print banner
        print("\n" + "=" * 60)
        ColorText.print_colored("    🤖 JARVIS AI ASSISTANT", ColorText.BOLD + ColorText.CYAN)
        print("=" * 60 + "\n")
